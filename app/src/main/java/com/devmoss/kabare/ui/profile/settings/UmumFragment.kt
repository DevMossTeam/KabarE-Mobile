...
class UmumFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Inisialisasi komponen Nama Lengkap
        ...
        // Inisialisasi komponen Username
        ...
        // Inisialisasi komponen untuk tombol simpan dan batal social media
        ...
        // Set OnClickListeners untuk tombol simpan dan batal social media
        ...
        // Set OnClickListeners untuk setiap ikon edit
        ...
        // Set Listener untuk batas karakter info
        ...
        // Set onClickListener for the button to add social media
    ...
    private fun showNextSocialMediaLayout() {
        ...
        if (linkCount < socialMediaLinks.size) {
            ...
            layout.findViewById<View>(when (linkCount) {
                0 -> R.id.separator1
                1 -> R.id.separator2
                2 -> R.id.separator3
                3 -> R.id.separator4
            ...
            layout.findViewById<TextView>(when (linkCount) {
    ...
    private fun cancelSocialMediaLink(index: Int) {
        ...
        val editText = layout.findViewById<EditText>(when (index) {
        ...
        layout.findViewById<View>(when (index) {
            1 -> R.id.separator1
            2 -> R.id.separator2
            3 -> R.id.separator3
            4 -> R.id.separator4
        ...
        layout.findViewById<TextView>(when (index) {
