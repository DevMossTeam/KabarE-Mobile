...
//    private val KeamananViewModel: KeamananViewModel by activityViewModels()
//
...
//        KeamananViewModel.otpValidationResult.observe(viewLifecycleOwner) { result ->
//            when (result.status) {
//                KeamananViewModel.AuthStatus.SUCCESS -> {
...
//                    dismiss()
//                }
//                KeamananViewModel.AuthStatus.FAILURE -> {
...
//        }
//
//        KeamananViewModel.emailVerificationResult.observe(viewLifecycleOwner) { result ->
//            when (result.status) {
//                KeamananViewModel.AuthStatus.SUCCESS -> {
//                    startTimer()
//                }
...
//        resendTextView.isEnabled = false
//
//        KeamananViewModel.resendOtp()
//        KeamananViewModel.passwordResetResult.observe(viewLifecycleOwner) { result ->
//            when (result.status) {
//                KeamananViewModel.AuthStatus.SUCCESS -> {
...
//            KeamananViewModel.verifyOtp(enteredOtp)
//        }
//    }
//
