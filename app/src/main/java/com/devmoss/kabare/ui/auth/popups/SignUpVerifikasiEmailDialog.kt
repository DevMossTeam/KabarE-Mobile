...
class SignUpVerifikasiEmailDialog : BottomSheetDialogFragment() {
    ...
    private var email: String? = null // Email should be nullable to check if provided.
    private lateinit var countDownTimer: CountDownTimer // To ensure proper cancelation

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for the verification email dialog
        ...
        if (email != null) {
            ...
            messageTextView.text = "Email tidak ditemukan, silahkan coba lagi."
        }
    ...
    private fun startTimer() {
        ...
        countDownTimer = object : CountDownTimer(120000, 1000) { // 2 minutes timer
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        countDownTimer.cancel() // Ensure the timer is cancelled when the fragment is destroyed.
    }
